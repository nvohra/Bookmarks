...
class UserController extends AbstractActionController
{
     ...
     * @param UserDao $model
     */
    function __construct(UserDao $model, UserForm $form)
    {
        $this->model = $model;
        $this->form = $form;
    }
    ...
    public function createAction()
    {
        ...
        $this->form->setAttribute('action', $this->url()->fromRoute('user\user\doCreate'));
    ...
    public function doCreateAction()
    {
        ...
        if ($request->isPost()) {
            ...
            $view->setTemplate('user/user/create.phtml');

            return $view;
        }

        return $this->redirect()->toRoute('user\user\create');
    }
    ...
    public function updateAction()
    {
        ...
        $this->form->setAttribute('action', $this->url()->fromRoute('user\user\doUpdate'));
        $user->setPassword('');
        $this->form->bind($user);
